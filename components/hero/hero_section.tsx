...
const Navbar: React.FC = () => {
  ...
  const togglePing=()=>{
    ...
    if(!pingActive) router.push('/ctf?cmd=ping 8.8.8.8');
  }
...
export const Component: React.FC = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center px-6 sm:px-8 md:px-12 overflow-hidden">
      ...
      <div className="relative z-10 text-center w-full max-w-4xl mx-auto flex flex-col items-center justify-center min-h-screen py-8 sm:py-16">
        ...
        {/* <div className="flex justify-center space-x-6">
          <a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-300">
            <Instagram size={20} className="w-5 h-5 sm:w-5.5 sm:h-5.5" />
          </a>
          <a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-300">
            <LinkedinIcon size={20} className="w-5 h-5 sm:w-5.5 sm:h-5.5" />
          </a>
          <a href="#" className="text-gray-500 hover:text-gray-300 transition-colors duration-300">
            <Github size={20} className="w-5 h-5 sm:w-5.5 sm:h-5.5" />
          </a>
        </div> */}
      </div>
    </section>
